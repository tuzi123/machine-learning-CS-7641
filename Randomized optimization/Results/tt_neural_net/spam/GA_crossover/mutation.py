...
plt.title('Error vs Iteration for GA with Different Crossover Probability')

fig.savefig('Plots/Error vs Iteration for GA with Different Crossover Probability.png')
plt.close()
