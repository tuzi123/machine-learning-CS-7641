 ...
 * @version 1.0
 */
public class GA_crossover {

    private static final String BASE_OUTPUT_DIR_PATH = "outputs/tt_neural_net/spam/GA_crossover/";
    ...
    private static int crossover_rate = 10;
    private static int population =200;
    private static int crossover = 50;
    ...
    public static void main(String[] args) {
        if (args.length > 0) 
            crossover_rate = Integer.parseInt(args[0]);
        ...
        crossover = population*crossover_rate/100;
        oa[0] = new StandardGeneticAlgorithm(population, 10, crossover, nnop[0]);
        ...
        for(int i = 0; i < oa.length; i++) {
            ...
            displayResults += oaNames[i] + "," + crossover_rate + "," +  VERSION_NO +
                                ","  + correct + "," + incorrect + "," +
    ...
    private static void train(OptimizationAlgorithm oa, BackPropagationNetwork network, String oaName) {
        ...
        try {
            String fileName = getFullFileName("errors_" +  VERSION_NO + "_" + crossover_rate+ ".csv");
            PrintWriter writer = new PrintWriter(new FileOutputStream(new File(fileName), true));
            writer.println("---");
