 ...
 * @version 1.0
 */
public class NueralNetSpam {

    private static final String BASE_OUTPUT_DIR_PATH = "outputs/tt_neural_net/spam/Three/";
    ...
    private static int INPUT_LAYERS = 57, HIDDEN_LAYERS = 2, OUTPUT_LAYER = 1, TRAINING_ITERATIONS = 200;
    ...
    public static void main(String[] args) {
        ...
        oa[1] = new SimulatedAnnealing(1E11, .84, nnop[1]);
