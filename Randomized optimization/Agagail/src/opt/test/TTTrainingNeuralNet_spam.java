 ...
 * @version 1.0
 */
public class TTTrainingNeuralNet_spam {

    private static final String BASE_OUTPUT_DIR_PATH = "outputs/tt_neural_net/spam/";
    ...
    private static int INPUT_LAYERS = 57, HIDDEN_LAYERS = 2, OUTPUT_LAYER = 1, TRAINING_ITERATIONS = 50;
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < oa.length; i++) {
            double start = System.nanoTime(), end, trainingTime, testingTime, correct_train=0, incorrect_train=0, correct_test = 0, incorrect_test = 0;
            ...
            for(int j = 0; j < instances_train.length; j++) {
                ...
                //System.out.println("j:" +j + " predicted train: " + predicted + " actual train: "+ actual+ "correct: "+correct_train+ " incorrect: "+incorrect_train);
            }
            ...
            displayResults += oaNames[i] + "," + TRAINING_ITERATIONS + "," +  VERSION_NO +
                                ...
                                df.format(correct_test/(correct_test+incorrect_test)*100) + ","+correct_train + "," + incorrect_train + "," +
        ...
        try {
            String fileName = getFullFileName("outputs_train_test_" +  VERSION_NO + ".csv");
    ...
    private static void train(OptimizationAlgorithm oa, BackPropagationNetwork network, String oaName) {
        ...
        for(int i = 0; i < TRAINING_ITERATIONS; i++) {
            ...
            double error = 0, correct=0, incorrect=0;
            for(int j = 0; j < instances_train.length; j++) {
        ...
        try {
            String fileName = getFullFileName("errors_train_test_" +  VERSION_NO + "_" + TRAINING_ITERATIONS + ".csv");
            PrintWriter writer = new PrintWriter(new FileOutputStream(new File(fileName), true));
            writer.println("---");
