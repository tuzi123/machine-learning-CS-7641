...
algs = ['0.19', '0.49', '0.59', '0.89']
plt.legend(algs, loc='upper right')
plt.title('Error vs Iteration for SA with Different Cooling Rate')

fig.savefig('Plots/Error vs Iteration for SA with Different Cooling Rate1.png')
plt.close()
