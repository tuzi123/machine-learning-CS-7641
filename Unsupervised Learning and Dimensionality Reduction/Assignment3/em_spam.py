...
plt.scatter(centroids[:, 0], centroids[:, 1],
            ...
            color='w', zorder=10)
plt.title('EM clustering on Spam dataset after PCA\n'
          'Centroids are marked with white cross')
plt.xlim(x_min, x_max)
plt.ylim(y_min, y_max)
plt.xticks(())
plt.yticks(())
file_name = 'Plots/EM Spam after PCA '+ str(n_components) + '.png'
...
plt.scatter(centroids[:, 0], centroids[:, 1],
            marker='x', s=169, linewidths=3,
            color='w', zorder=10)
plt.title('EM clustering on Spam dataset after ICA\n'
          'Centroids are marked with white cross')
plt.xlim(x_min, x_max)
plt.ylim(y_min, y_max)
plt.xticks(())
plt.yticks(())
file_name = 'Plots/EM Spam after ICA '+ str(n_components) + '.png'
fig.savefig(file_name )
plt.close()
...
plt.scatter(centroids[:, 0], centroids[:, 1],
            marker='x', s=169, linewidths=3,
            color='w', zorder=10)
plt.title('EM clustering on Spam dataset after RP\n'
          'Centroids are marked with white cross')
plt.xlim(x_min, x_max)
plt.ylim(y_min, y_max)
plt.xticks(())
plt.yticks(())
file_name = 'Plots/EM Spam after RP '+ str(n_components) + '.png'
fig.savefig(file_name )
plt.close()
...
plt.scatter(centroids[:, 0], centroids[:, 1],
            marker='x', s=169, linewidths=3,
            color='w', zorder=10)
plt.title('EM clustering on Spam dataset after LDA\n'
          'Centroids are marked with white cross')
plt.xlim(x_min, x_max)
plt.ylim(y_min, y_max)
plt.xticks(())
plt.yticks(())
file_name = 'Plots/EM Spam after LDA '+ str(n_components) + '.png'
fig.savefig(file_name )
plt.close()