...
plt.scatter(centroids[:, 0], centroids[:, 1],
            ...
            color='w', zorder=10)
plt.title('Kmeans clustering on Pima dataset after PCA\n'
          'Centroids are marked with white cross')
plt.xlim(x_min, x_max)
plt.ylim(y_min, y_max)
plt.xticks(())
plt.yticks(())
file_name = 'Plots/Kmeans Pima after PCA '+ str(n_components) + '.png'
...
plt.scatter(centroids[:, 0], centroids[:, 1],
            marker='x', s=169, linewidths=3,
            color='w', zorder=10)
plt.title('Kmeans clustering on Pima dataset after RP\n'
          'Centroids are marked with white cross')
plt.xlim(x_min, x_max)
plt.ylim(y_min, y_max)
plt.xticks(())
plt.yticks(())
file_name = 'Plots/Kmeans Pima after RP '+ str(n_components) + '.png'
fig.savefig(file_name )
plt.close()
...
plt.scatter(centroids[:, 0], centroids[:, 1],
            marker='x', s=169, linewidths=3,
            color='w', zorder=10)
plt.title('Kmeans clustering on Pima dataset after LDA\n'
          'Centroids are marked with white cross')
plt.xlim(x_min, x_max)
plt.ylim(y_min, y_max)
plt.xticks(())
plt.yticks(())
file_name = 'Plots/Kmeans Pima after LDA '+ str(n_components) + '.png'
fig.savefig(file_name )
plt.close()