...
'''
learning_in = pd.read_csv('DataSet_2/Sampled_Input_Data_1hot.csv')
learning_in = learning_in.as_matrix()
learning_out = pd.read_csv('DataSet_2/Sampled_Output_Data_1hot.csv')
learning_out = learning_out.as_matrix()
'''
...
plt.legend(loc="best")
fig.savefig('Plots/KNN Learning Curve for both.png')
plt.close()
